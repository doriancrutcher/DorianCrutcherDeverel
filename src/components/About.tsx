      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            <span className="text-secondary">Developer Relations Engineer</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Building developer communities, creating educational content, and empowering developers through technical education. With Developer Relations experience that sharpened my ability to create compelling demos, educational resources, and accelerate developer adoption.
          </p>
        </motion.div>
              ...
              <CardContent className="p-8">
                <div className="flex items-center space-x-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-secondary font-medium">Developer Relations Engineer</p>
                    <p className="text-sm text-muted-foreground">Community Builder & Technical Educator</p>
                  </div>
                </div>
                
                <p className="text-muted-foreground leading-relaxed">
                  I've spent 5+ years building developer communities, creating educational content, and empowering developers through technical education. My work spans full-stack development, developer relations, and community building, always with a focus on education, content creation, and community growth. I've led technical workshops for 50+ developers, created educational resources for thousands, and grown technical communities from hundreds to <strong>10,000+</strong>.
                </p>
              </CardContent>
            </Card>
                  ...
                  <Card className="bg-secondary/5 border-secondary/20 hover:shadow-md transition-shadow duration-300">
                    <CardContent className="p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-1">Creating Educational Content & Resources</h5>
                          <p className="text-sm text-muted-foreground">Building tutorials, documentation, and learning resources that help developers succeed with technical tools and platforms.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-secondary/5 border-secondary/20 hover:shadow-md transition-shadow duration-300">
                    <CardContent className="p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-1">Community Building & Engagement</h5>
                          <p className="text-sm text-muted-foreground">Fostering developer communities through events, workshops, and ongoing engagement that helps developers learn and grow together.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-secondary/5 border-secondary/20 hover:shadow-md transition-shadow duration-300">
                    <CardContent className="p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-1">Technical Education & Developer Enablement</h5>
                          <p className="text-sm text-muted-foreground">Empowering developers through clear documentation, hands-on workshops, and technical content that makes complex concepts accessible.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
