...
import { Code, Bot, Database, Globe, ArrowRight } from "lucide-react";
...
export function Services() {
  const skills = [
    ...
    },
    {
      ...
      title: "Developer Relations & Community Engagement",
      description: "Building developer communities, creating educational content, and empowering developers through technical education. I specialize in content creation, developer enablement, and community growth from SDK tutorials to developer workshops and technical documentation.",
      technologies: [
              ...
              <CardContent className="space-y-4">
                ...
                <button 
                  onClick={() => skill.title === "Frontend Development" 
                    ...
                    : skill.title === "Developer Relations & Community Engagement"
                ...
                >
                  <span>{skill.title === "Frontend Development" || skill.title === "Backend Development" ? "View GitHub Projects" : skill.title === "AI-Powered Applications" ? "Watch AI Demo" : skill.title === "Developer Relations & Community Engagement" ? "View Pagoda SDK Work" : "See Examples"}</span>
